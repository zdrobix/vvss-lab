 ...
 * - ID: 1 (valid)
 * - Categorie: CategorieBautura.JUICE
 * - Tip: TipBautura.WATER_BASED
 */
        ...
        class ECPTests {
                ...
                void testAddProductECP(String priceStr, String name, boolean shouldThrow) {
                        ...
                        Product product = new Product(
                                        ...
                                        name,
                                        price,
                                        CategorieBautura.JUICE, // Categorie - valid (dummy)
                                        TipBautura.WATER_BASED // Tip - valid (dummy)
                        );
        ...
        class BVATests {
                ...
                void testAddProductBVA(String priceStr, int nameLength, String name, boolean shouldThrow) {
                        ...
                        if (nameWithCorrectLength.length() < nameLength) {
                                nameWithCorrectLength = nameWithCorrectLength
                                                + "A".repeat(nameLength - nameWithCorrectLength.length());
                        }
                        ...
                        return Stream.of(
                                        ...
                                        org.junit.jupiter.params.provider.Arguments.of(
                                                        ...
                                                        new Product(1, "X".repeat(50), 10000.00,
                                                                        CategorieBautura.SPECIAL_COFFEE,
